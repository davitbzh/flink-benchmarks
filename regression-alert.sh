...
median_trend_threshold=-1 # change threshold of trend median, percent
dev_ratio_threshold=5 # threshold for ratio of last deviation to MAD # todo: use percentile
